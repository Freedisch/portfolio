      ...
      <div className="w-full max-w-3xl mx-auto mb-28 px-4">
        <div className="mt-4 sm:pl-[15%] text-sm w-fit sm:w-full flex flex-col sm:flex-row gap-5 sm:gap-0 justify-between">
          ...
          <a
            ...
            href="https://dev.to/freedisch_10/"
            rel="noreferrer"
            target="_blank"
          >
            <svg
          ...
          <a
            className="linkstyle flex gap-2 items-center"
            href="https://drive.google.com/file/d/1lZjnzGDsY5qozBk08rR-HodwUiz9iZmj/view?usp=sharing"
            rel="noreferrer"
            target="_blank"
          >
            <svg
          ...
          <div className="mt-14">
            <section className="mt-7">
              ...
              <div className="text-sm">
                ...
                <p className="my-5">
                  I build and unintentionally break things (which I eventually
                  fix 🙂). I have keen interests in software development, system
              ...
              <div className="mt-7 grid grid-cols-2 w-fit xs:w-full xs:flex xs:justify-end gap-6 items-center text-sm">
                ...
                <a
                  href="https://www.linkedin.com/in/magnim-thibaut-batale-905843208/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <div className="linkstyle leading-dot">
            ...
            <div id="experience">
              ...
              <div>
                <div className="content-card my-5 px-4 py-5 border-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  ...
                  >
                    ...
                    <div>Cloud Native Computing Foundation - LitmusChaos</div>
                  </a>
                  <div className="flex flex-col-reverse sm:flex-row sm:justify-between text-sm text-gray-500">
                    <div className=" flex items-center space-x-2 mb-1">
                      ...
                      <div>Spetember 2023 - December 2024</div>
                    </div>
                  </div>
                  <div className="text-sm mt-2 text-gray-600">
                    <p className="my-1">
                      - Implemented comprehensive Rest API documentation
                      utilizing go-swagger and swaggo library, ensuring clarity
                      and ease of use for developers.
                    </p>
                    <p className="my-1">
                      - Elevated the backend test coverage from 0% to 25.48% for
                      GRPC and REST handlers, utilizing the Go testing library
                      to enhance system reliability and performance
                    </p>
                    <p className="my-1">
                      - Enhanced frontend test coverage from 0% to 30.36%,
                      focusing on web views components through adept use of the
                      React testing library
                    </p>
                    <p className="my-1">
                      - Led the migration of code architecture to an interface
                      model, optimizing system structure allowing to write
                      efficient and maintainable test cases.
                    </p>
                    <p className="my-1">
                      - Optimized GraphQL handlers, significantly boosting
                      performance and user experience in data management and
                      retrieval
                    </p>
                  </div>
                </div>
                ...
                <div className="content-card my-5 px-4 py-5 border-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  ...
                  <div className="text-sm mt-2 text-gray-600">
                    ...
                    <p className="my-1">
                      - Developed APIs to support new features and enhanced
                      existing endpoints to ensure consistency.
                    </p>
                    <p className="my-1">
                      - Wrote a manifest file for Prometheus deployment and
                      setup communication between Prometheus and Node exporter
                      to scrape metrics from the running cluster.
                    </p>
                    <p className="my-1">
                      - Migrated API documentation from Swagger to Redocly and
                      added workflow to enable new release of the documentation
                      whenever changes are being made..
                    </p>
                  </div>
                </div>

                <div className="content-card my-5 px-4 py-5 border-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  <div className="text-lg font-bold mb-1">Backend Engineer</div>
                  <a
                    href="https://www.linkedin.com/company/sheba-plastic/?originalSubdomain=rw"
                    target="_blank"
                    rel="noreferrer"
                    className="linkstyle flex text-black text-sm w-fit mb-1 space-x-2"
                  >
                  ...
                  <div className="text-sm mt-2 text-gray-600">
                    <p className="my-1">
                      - Migrated the backend server from Firebase to Node.js,
                      enhancing operational efficiency and scalability for
                      improved system performance, and wrote CI workflows for
                      software maintenance and reliability.
                    </p>
                    <p className="my-1">
                      - Added unit test cases for the Rest API reaching a test
                      coverage of 72% using mocha chai library.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="content-card my-5 px-4 py-5 border-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  ...
                  <div className="text-sm mt-2 text-gray-600">
                    <p className="my-1">
                      - Assist wilco users on a weekly basis and worked along
                      with the wilco team to grow their developer community. 👮‍♂️
                    </p>
                    <p className="my-1">
                ...
                <div className="content-card my-5 px-4 py-5 border-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  ...
                  <div className="text-sm mt-2 text-gray-600">
                    <p className="my-1">
                      ...
                      builds to separate dependencies and artifacts into
                      different stages
                    </p>
                    <p className="my-1">
                      - Reduced the number of layers by combining run
                      instructions
                    </p>
                    <p className="my-1">
              ...
              <div>
                ...
                <section className="content-card group my-5 sm:grid grid-cols-8 items-center order-2 border-blue-500 shadow-lg hover:border-purple-500 hover:shadow-2xl">
                  ...
                  <div className="col-span-5 px-4 py-5">
                    ...
                    <div className="text-sm text-gray-600">
                      <p className="last:mb-0 my-1">
                        - Won the 2nd prize during the 24-hour hackathon
                        organized by Major League Hacking with my project
                        AI-Coach, a platform powered by GPT-3 that sends daily
                        project-based learning via WhatsApp to help you improve
                        your skills.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-span-5 px-4 py-5">
                    ...
                    <div className="text-sm text-gray-600">
                      <p className="last:mb-0 my-1">
                        ...
                        made with canavas to improve the user experience with
                        new features.
                      </p>
                      <p className="last:mb-0 my-1">
                        - Built the client with react and tailwind css. Used
                        redux toolkit to manage state cross the different
                        components
                      </p>
                    </div>
                  </div>
